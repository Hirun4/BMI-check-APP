                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: gender == "M"
                                  ? const Color.fromARGB(255, 247, 194, 227)
                                  : const Color.fromARGB(115, 226, 205, 217),
                ...
                Column(
                  children: [
                    const Text(
                      ...
                      style: TextStyle(
                          fontSize: 70,
                          color: Color.fromARGB(255, 233, 109, 198),
                          fontWeight: FontWeight.w500),
                    ),
                    Text(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            gender == "M" ? "You are male" : "You are female",
                            style: const TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.w500,
                                color: Colors.black),
